...
import { nf, esc } from '../../src/core/format.js';
import { ymKey, md, todayISO } from '../../src/core/date.js';
...
describe('日期工具', () => {
  it('ymKey 產生 YYYY-MM', () => {
    expect(ymKey('2026-03-05')).toBe('2026-03');
    expect(ymKey('2026-12-31')).toBe('2026-12');
  });
